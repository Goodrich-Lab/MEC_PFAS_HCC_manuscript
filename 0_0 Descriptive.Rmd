...
table1::table1(~.|status, data_hcc %>% select(status, all_of(pfas_name), blood_age, bmi_cat, alcohol_intake_cat,smokestatus, diabetes, eth, studyarea, sex, year_between, q1_dp_amds_totscore, q1_fdgp7, q1_calories))
```
...
data_hcc %>% select(blood_age, status, eth, bmi_cat, alcohol_intake_cat, smokestatus, diabetes, studyarea, sex, year_between,q1_dp_amds_totscore, q1_fdgp7, q1_calories) %>%
